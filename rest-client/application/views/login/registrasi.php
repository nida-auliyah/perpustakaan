            ...
            <div class="row">
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" action="<?= base_url('login/registrasi'); ?>" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="telepon" name="telepon" placeholder="No Telp" value="<?= set_value('telepon'); ?>">
